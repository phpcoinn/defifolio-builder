    ...
    <div className="mt-2">
      <div className="flex items-center justify-between mb-2">
        ...
        <button
            ...
            disabled={loading}
            className="text-xs flex items-center gap-1 text-crypto-accent hover:text-slate-900 dark:hover:text-white transition-colors disabled:opacity-50"
        >
      ...
      <textarea
        ...
        className="w-full bg-slate-50 dark:bg-slate-900 border border-slate-300 dark:border-slate-700 rounded p-3 text-sm focus:ring-2 focus:ring-crypto-accent focus:outline-none transition-all h-24 resize-none"
